...
public class MainTemp {
    public static void main(String[] args) {
        ...
        flights.add(new Flight(1, "Air India", 300, 300, 7500, "BOM", "DEL", "07-12-2022 11:45 IST",
                "07-12-2022 14:30 IST"));
        flights.add(
                new Flight(2, "Indigo", 250, 250, 7450, "DEL", "BOM", "07-12-2022 16:30 IST", "07-12-2022 18:40 IST"));
        flights.add(new Flight(3, "Spice jet", 250, 250, 5100, "BOM", "BLR", "08-12-2022 23:00 IST",
                "09-12-2022 00:45 IST"));
        flights.add(
                new Flight(4, "Indigo", 300, 300, 4950, "BLR", "BOM", "09-12-2022 12:00 IST", "09-12-2022 14:45 IST"));
